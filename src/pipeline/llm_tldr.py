...
输出写入 llm_outputs 表：
- tldr_zh: 200 字以内中文摘要
- topic_tags: ["团队", "领导力", "招聘", "决策", "伦理", "人机协作", "营销", "消费者", "HR", "组织变革", ...]
- ai_type_tags: ["GenAI", "LLM", "ChatGPT", "算法管理", "人机协作", ...]
...
TOPIC_TAG_HINTS = [
    "团队", "领导力", "招聘", "绩效评估", "决策", "伦理", "人机协作",
    "营销", "消费者行为", "广告", "品牌", "推荐系统",
    "HR", "员工幸福感", "组织变革", "组织学习", "知识管理",
    "创业", "战略", "创新", "创意",
    "工作设计", "工作未来", "零工经济", "算法管理",
    "信任", "公平性", "偏见", "隐私",
    "教育", "培训",
...
AI_TYPE_HINTS = [
    ...
    "算法管理", "算法决策", "推荐算法",
    "机器人", "机器学习", "AI 招聘", "AI 客服",
    "人机协作", "人机交互", "AI 治理", "可解释 AI",
]

SYSTEM_PROMPT = f"""你是一名精通组织行为学、营销学、管理学的中文学术编辑。
任务：对一批与 AI 相关的顶刊论文，输出三件事：
